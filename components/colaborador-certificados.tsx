        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                {certificados.length} certificado(s) cadastrado(s). A assinatura do colaborador é feita no Perfil do aplicativo; o status aparece na coluna «Assinatura colaborador».
              </CardDescription>
            </div>
            {!readOnly && (
