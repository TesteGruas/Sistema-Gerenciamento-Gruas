...
export const mockAprovacoes: AprovacaoHorasExtras[] = [
  {
    ...
    horas_extras: 2.5,
    data_trabalho: '2025-10-25',
    status: 'pendente',
    data_submissao: '2025-10-25T18:30:00Z',
    data_limite: '2025-11-01T18:30:00Z',
    funcionario: {
      nome: 'João Silva',
  ...
  {
    id: '6',
    registro_ponto_id: 'reg-006',
    funcionario_id: 'func-001',
    supervisor_id: 'super-001',
    horas_extras: 1.5,
    data_trabalho: '2025-10-25',
    status: 'pendente',
    data_submissao: '2025-10-25T17:30:00Z',
    data_limite: '2025-11-01T17:30:00Z',
    funcionario: {
      nome: 'João Silva',
      cargo: 'Operador de Grua',
      obra: 'Obra Centro'
  ...
  },
  {
    ...
    data_submissao: '2025-10-25T17:00:00Z',
    data_aprovacao: '2025-10-26T09:30:00Z',
    data_limite: '2025-11-01T17:00:00Z',
    funcionario: {
      nome: 'Pedro Costa',
  ...
  },
  {
    ...
    data_submissao: '2025-10-25T19:00:00Z',
    data_aprovacao: '2025-10-26T10:15:00Z',
    data_limite: '2025-11-01T19:00:00Z',
    funcionario: {
      nome: 'Ana Oliveira',
  ...
  },
  {
    ...
    data_submissao: '2025-10-25T18:00:00Z',
    data_limite: '2025-11-01T18:00:00Z',
    funcionario: {
      nome: 'Roberto Lima',
      cargo: 'Auxiliar de Operação',
      obra: 'Obra Norte'
