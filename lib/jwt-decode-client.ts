/**
 * Decodifica o payload (2º segmento) de um JWT.
 * O padrão JWT usa Base64URL; `atob()` só aceita Base64 clássico (+/ e padding).
 */

const BASE64URL_PAYLOAD = /^[A-Za-z0-9_-]+$/

/**
 * Normaliza o valor guardado no storage (Bearer, aspas JSON, espaços).
 */
